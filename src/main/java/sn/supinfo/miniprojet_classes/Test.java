...
import sn.supinfo.miniprojet_implements.imp.EtudiantGroupeImp;
import sn.supinfo.miniprojet_implements.imp.EtudiantImp;
import sn.supinfo.miniprojet_implements.imp.GroupeImp;
import sn.supinfo.miniprojet_implements.imp.ProfesseurImp;
...
public class Test {
     ...
     public static void main(String args[]){
         ...
         EtudiantGroupeImp etudiantgroupeImp =new EtudiantGroupeImp();
        int choix;
        ...
        do{
          ...
          switch(choix){
              case 1:
                 ...
                 switch(choix){
                     ...
                     case 1:System.out.println("Creation d'un groupe");
                          ...
                          System.out.println("Bravo Creation reussie !!!");
                     ...
                     case 3:System.out.println("Details d'un groupe");
                          ...
                          System.out.println("Nom groupe: "+groupe3.getNom_Groupe()+"\nDate de creation"+groupe3.getDate_creation()+"\nModule du groupe: "+groupe3.getModule_groupe());
                          break;
                     ...
                     case 5:System.out.println("Affichage des groupes");
                          ...
                          System.out.println("Nom des Groupes: "+groupe5.getNom_Groupe());
                     }
                          break;
            ...
            case 2:
                 ...
                 switch(choix){
                      ...
                      case 3:System.out.println(" Voire les details d'un etudiant");
                           ...
                           System.out.println("Prenom: "+etudiant3.getPrenom()+"\nNom: "+etudiant3.getNom()+"\nNumero Etudiant: "+etudiant3.getNumeroEtudiant()+"\nDepartement: "+etudiant3.getDepartement()+"\nDate de naissance: "+etudiant3.getDateNaissance());
                           break;
                      ...
                      case 5:System.out.println(" Afficher tous les etudiants");
                           ...
                           System.out.println("Prenom: "+etudiant5.getPrenom()+"\nNom: "+etudiant5.getNom());
                           }
                           break;
            ...
            case 3:
                 ...
                 switch(choix){
                      ...
                      case 2:System.out.println("Modification d'un professeur");
                           ...
                           String tel=cl.next();
                           System.out.println("Specialite du professeur");
                      ...
                      case 3:System.out.println(" Voire les details d'un professeur");
                           ...
                           System.out.println("Prenom: "+professeur3.getPrenom()+"\nNom: "+professeur3.getNom()+"\nAdresse: "+professeur3.getAdresse()+"\nTelephone: "+professeur3.getTelephone()+"\nSpecialité: "+professeur3.getSpecialite());
                      break;
                      case 4:System.out.println(" Supprimer un professeur");
                           System.out.println("Donner l'id du professeur:");
                           idProf=cl.nextInt();
                      ...
                      case 5:System.out.println(" Afficher tous les professeurs");
                           ...
                           System.out.println("Prenom: "+professeur5.getPrenom()+"\nNom: "+professeur5.getNom());
                           };break;
                      case 6:System.out.println("Au revoir !");
                              System.exit(0);break;
            ...
            case 4:
                 ...
                 System.out.println(" 2- Supprimer un etudiant du groupe");
                 System.out.println(" 3- Afficher tous les etudiants du groupe");
                 ...
                 switch(choix){
                      ...
                      case 1:System.out.println(" Ajout d'un etudiant dans un groupe");
                            System.out.println("Donner l'id du groupe");
                            int idGroupe=cl.nextInt();
                            System.out.println("id de l'etudiant");
                            int idEtudiant=cl.nextInt();
                            ...
                            System.out.println("Date de naissance: ");
                            String dateNaissance=cl.next();
                            EtudiantGroupe groupe=new EtudiantGroupe(idEtudiant,prenom, nom, numeroEtudiant, departement, dateNaissance);
                            groupeImp.addEtudiantGroupe(groupe);
                          System.out.println("Bravo Creation reussie !!!");
                      break;
                      case 2:System.out.println("Supprimer un etudiant d'un groupe ");
                            System.out.println("Donner l'id du groupe");
                            int idGroupe1=cl.nextInt();
                            Etudiant Groupe=GroupeImp.getEtudiantById(idGroupe1);
                           etudiantgroupeImp.removeEtudiantGroupe(Groupe);
                           System.out.println("Suppression reussie");
                      break;
                      case 3:System.out.println("Affichage des etudiants du groupe");
                      System.out.println("Donnez l'id du groupe");
                      idGroupe=cl.nextInt();
                      List<Groupe> etudiants=etudiantgroupeImp.getAllEtudiantGroupe();
                      for(Groupe etudiant3:etudiants){
                           System.out.println("Prenom: "+etudiant3.getNom_Groupe());
                           }
